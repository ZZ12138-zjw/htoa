        ...
        <form class="layui-form" id="userForm">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <textarea name="weekCur"  id="weekCur" class="layui-textarea"></textarea>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <textarea name="studentQuestion"  id="studentQuestion" class="layui-textarea"></textarea>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <textarea name="idea"  id="idea" class="layui-textarea"></textarea>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <textarea name="weekNext"  id="weekNext" class="layui-textarea"></textarea>
                </div>
            </div>
