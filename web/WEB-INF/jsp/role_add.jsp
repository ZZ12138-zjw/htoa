  ...
  <body>
    <div class="x-body">
        <form class="layui-form" lay-filter="add">
          ...
          <div class="layui-form-item">
              <label for="groupinfo" class="layui-form-label">
                  <span class="x-red"></span>角色介绍
              </label>
              <div class="layui-input-inline">
                  <textarea name="groupinfo"  id="groupinfo" placeholder="请输入内容" class="layui-textarea"></textarea>
              </div>
          </div>
    ...
    <script>
        layui.use(['form','layer'], function(){
          ...
          form.on('submit(formDemo)',function(data){
            //发异步，把数据提交给后台
              $.ajax({
                  url:'${pageContext.request.contextPath}/quanXie/roleAdd',
                  type:'post',
                  data:data.field,
                  dataType:'json',
