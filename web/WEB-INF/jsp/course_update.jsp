    ...
    <div class="x-body">
        <form class="layui-form" lay-filter="add">
              ...
              <div class="layui-form-item">
                  ...
                  <div class="layui-input-inline">
                      <select id="isobligatory"  name="isobligatory" lay-verify="required">
                          <option value="是" <c:if test="${courseVo.isobligatory}">selected</c:if>>是</option>
                          <option value="否" <c:if test="${courseVo.isobligatory}">selected</c:if>>否</option>
                      </select>
                  </div>
              </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select id="courseTypeId"  name="courseTypeId" lay-verify="required">
                        <c:forEach items="${courseTypeList}" var="cou">
                            <option value="${cou.courseTypeId}" ${courseVo.courseTypeId==cou.courseTypeId ? 'selected' : ''}>${cou.courseTypeName}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <textarea name="remark"  id="remark" placeholder="请输入内容" class="layui-textarea">${courseVo.remark}</textarea>
              </div>
          </div>
